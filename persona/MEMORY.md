...
- **Primary email**: `angela.brooks@Finthesiss.ai`. Gmail, Google Calendar, Google Contacts, and Google Drive all connected.
...
- **Instagram, Twitter, Discord**: connected, read context only. Studios have begun DM'ing her on Instagram; flag for review.
